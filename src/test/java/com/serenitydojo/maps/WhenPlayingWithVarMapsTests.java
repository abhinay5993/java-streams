...
/**
 * This test class covers - Bonus Live Videos : Advanced Java - The 'Var'
 * Keyword implementation with Maps/HashMaps from
 * 'java-for-testers-and-test-automation' course of 'Serenity Dojo training and
 * mentoring programme'
 * 
 */

public class WhenPlayingWithVarMapsTests {
    ...
    var countryCapitals = new HashMap<>();
    ...
    var favoriteFood = Map.of("cat",TUNA,"dog",DELUXE_DOG_FOOD,"hamster",LETTUCE);
	...
	var numberOfBallsByColor = new HashMap<String, Integer>();
	...
	//Unmodifyable maps
	var numberOfBallsByColor = Map.of("red", 3, "green", 6, "blue", 5);
	//Modifyable Maps
	var moreColors = new HashMap<>();
	...
	var modifiableMap = new HashMap<String, Integer>();
	...
	private void printMap(Map<String, Integer> numberOfBallsByColor) {
		for (var entry : numberOfBallsByColor.entrySet()) {
